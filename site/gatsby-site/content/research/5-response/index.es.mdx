...
**An AI Incident Response refers to a public official response to an [incident](/research/1-criteria) in the AI Incident Database (AIID) from an [entity](/entities) (i.e. company, organization, individual) allegedly responsible for developing or deploying the AI or AI system involved in said incident.** An AI Incident Response typically contains reasonably adequate information about the incident regarding:
...
The AI Incident Database is designed to provide information, structure, and perspectives on AI incidents. If you are listed as an entity for one or more incidents, we would very much like to work with you to provide your perspective. You can either [submit a response directly](#todo) to the database, or [contact us](/contact) to discuss submitting a response.
