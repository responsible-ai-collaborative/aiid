  ...
  <tbody>
    <tr>
      <td className="alinear-borde superior-1 borde-gris-200 px-4 py-2">
        <em>Incidente n.° 376:</em>
        <a href="/cite/376">
          El algoritmo de RealPage elevó los precios de alquiler, supuestamente de forma artificial
        </a>
      </td>
      <td className="alinear-borde superior-1 border-gris-200 px-4 py-2">
        <ul>
          <li>
            Cómo un algoritmo de alquiler secreto aumenta los alquileres:
            <em>
          ...
          <li>
            ¿Un algoritmo está aumentando su renta? Una nueva demanda colectiva dice que sí -
            <em>
          ...
          <li>
            El software YieldStar de RealPage puede estar aumentando los alquileres -
            <em>
              <a href="https://therealdeal.com/2022/10/17/realpage-algorithm-could-be-driven-up-rents/">
                El trato real
              </a>
    ...
    <tr>
      <td className="alinear-borde superior-1 borde-gris-200 px-4 py-2">
        <strong>Incidente n.° 373:</strong>
        <a href="/cite/373">
          El algoritmo MiDAS de beneficios de desempleo de Michigan emitió reclamos de fraude falsos
      ...
      <td className="alinear-borde superior-1 borde-gris-200 px-4 py-2">
        <ul>
          <li>
            La lucha de siete años para mantener un algoritmo fuera de control para dar cuenta -
            <em>
              <a href="https://themarkup.org/newsletter/hello-world/the-seven-year-struggle- para-mantener-un-algoritmo-fuera-de-control-a-la-cuenta">
                El marcado
              </a>
          ...
          <li>
            Michigan resolverá la demanda por falso fraude de desempleo de 2015 por $20 millones -
            <em>
    ...
    <tr>
      <td className="alinear-borde superior-1 borde-gris-200 px-4 py-2">
        <strong>Incidente n.° 267:</strong>
        <a href="/cite/267">
          Algoritmo de inteligencia artificial Clearview creado a partir de fotos extraídas de
          perfiles de redes sociales sin consentimiento
        </a>
      </td>
      <td className="alinear-borde superior-1 borde-gris-200 px-4 py-2">
        <ul>
          <li>
            El regulador francés multa a la empresa estadounidense de reconocimiento facial
            Clearview AI con 20 millones de euros,
            <em>
    ...
    <tr>
      <td className="alinear-borde superior-1 borde-gris-200 px-4 py-2">
        <strong>Incidente n.° 382:</strong>
        <a href="/cite/382">
          La exposición de contenido dañino en Instagram contribuyó al suicidio de una adolescente
        </a>
      </td>
      <td className="alinear-borde superior-1 borde-gris-200 px-4 py-2">
        <ul>
          <li>
            Gobierno británico culpa a las redes sociales por suicidio de adolescente -
            <em>
