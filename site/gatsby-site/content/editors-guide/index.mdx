...
- **AI issue**: 
  an alleged harm or near harm by an Al system 
...
<table>
  ...
  <tr>
    <td>Studies documenting theoretical or conceptual flaws in AI technology</td>
    <td>
  ...
  <tr>
    <td>Thought experiments and hypothetical examples</td>
    <td>
  ...
  <tr>
    <td>Discussions of broad types of AI incidents or harmful AI behaviors</td>
    <td>
  ...
  <tr>
    <td>Misleading marketing of AI products</td>
    <td>
...
1. One empty space between paragraphs
2. Strip advertisement text, caption text
3. Format with Markdown (i.e., if you are providing links within the text)
...
- Should ideally be distinguishable from that of other reports
- Should communicate AI system of interest and the nature of harm
- Little effort to decipher the AI element for non-technical users 
- Ideally requires little update and correction over time, 
  regardless of follow-up events

#### Rule set

1. Use title case <!-- Needs definition -->
2. Use past tense
...
The following is a list of documented bi
ases as experienced by editors of the AIID:
...
2. Confirmation bias
3. Cultural bias
   1. What is it? Interpretation and judgment by standards 
      inherent to one's own culture.
   2. What does it look like in practice?
      - Perception of harms in AI varies by culture, 
        making some incidents easily or harder to pass ingestion criteria
