  ...
  field_list: [
    {
      ...
      display_type: 'list',
      mongo_type: 'array',
      complete_from: { all: ['Known AI Goal', 'Potential AI Goal'] },
      default: '',
      placeholder: '',
      permitted_values: [],
      weight: 50,
    ...
    },
    {
      ...
      subfields: [
        ...
        },
        {
          ...
          display_type: 'list',
          mongo_type: 'array',
          complete_from: { current: ['Known AI Goal'] },
          default: '',
          placeholder: '',
          permitted_values: [],
          weight: 50,
    ...
    },
    {
      ...
      subfields: [
        ...
        },
        {
          ...
          display_type: 'list',
          mongo_type: 'array',
          complete_from: { current: ['Potential AI Goal'] },
          default: '',
          placeholder: '',
          permitted_values: [],
          weight: 50,
    ...
    },
    {
      ...
      display_type: 'list',
      mongo_type: 'array',
      complete_from: { all: ['Known AI Technology', 'Potential AI Technology'] },
      default: '',
      placeholder: '',
      permitted_values: [],
      weight: 50,
    ...
    },
    {
      ...
      subfields: [
        ...
        },
        {
          ...
          display_type: 'list',
          mongo_type: 'array',
          complete_from: { current: ['Known AI Technology'] },
          default: '',
          placeholder: '',
          permitted_values: [],
          weight: 50,
    ...
    },
    {
      ...
      subfields: [
        ...
        },
        {
          ...
          display_type: 'list',
          mongo_type: 'array',
          complete_from: { current: ['Potential AI Technology'] },
          default: '',
          placeholder: '',
          permitted_values: [],
          weight: 50,
    ...
    },
    {
      ...
      display_type: 'list',
      mongo_type: 'array',
      complete_from: { all: ['Known AI Technical Failure', 'Potential AI Technical Failure'] },
      default: '',
      placeholder: '',
      permitted_values: [],
      weight: 50,
    ...
    },
    {
      ...
      subfields: [
        ...
        },
        {
          ...
          display_type: 'list',
          mongo_type: 'array',
          complete_from: { current: ['Known AI Technical Failure'] },
          default: '',
          placeholder: '',
          permitted_values: [],
          weight: 50,
    ...
    },
    {
      ...
      subfields: [
        ...
        },
        {
          ...
          display_type: 'list',
          mongo_type: 'array',
          complete_from: { current: ['Potential AI Technical Failure'] },
          default: '',
          placeholder: '',
          permitted_values: [],
          weight: 50,
