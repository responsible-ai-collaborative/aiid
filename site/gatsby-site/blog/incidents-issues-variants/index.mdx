...
<table>
    <tr>
        ...
        <td className='w-1/2 align-top'><a href="/reports/2304">"China develops AI 'prosecutor' to press charges 'with 97% accuracy'"</a><p>Not an incident: The inevitable harm event has not happened yet.</p></td>
    </tr>
    <tr>
        <td className='w-1/2 align-top'><a href="/reports/2296">"AI and deepfakes present new risks for internet relationships"</a><p>Not an incident: We lack a specific example.</p></td>
        <td className='w-1/2 align-top'>
    ...
    <tr>
        ...
        <td className='w-1/2 align-top'><a href="/reports/2294">"Slight Street Sign Modifications Can Completely Fool Machine Learning Algorithms"</a><p>Not an incident: The vulnerability has yet to be exploited.</p></td>
    </tr>
</table>
...
We recently made "issue reports" available in the AI Incident Database. You can now search the growing list of [issues](/apps/discover?display%3Ddetails%26is_incident_report%3Dfalse%26page%3D1&sa=D&source=editors), which are also [machine translated](/blog/multilingual-incident-reporting) into [Spanish](/es/apps/discover?display%3Ddetails%26is_incident_report%3Dfalse%26page%3D1&sa=D&source=editors) and [French](/fr/apps/discover?display%3Ddetails%26is_incident_report%3Dfalse%26page%3D1&sa=D&source=editors). You can also search simultaneously across incidents and issues to explore emerging and realized risks in the world.
...
<table>
    <tr>
        <td className='w-1/2 align-top'>
            <div className='bg-blue-900'><img src="./images/image2.png" /></div>
        </td>
        <td className='w-1/2 align-top'>
...
<table>
    ...
    <tr>
        <td colspan="2">
            McGregor, S., Paeth, K., & Lam, K. (2022). Indexing AI Risks with Incidents, Issues, and Variants. In Proceedings of the [NeurIPS Workshop on Human-Centered AI](https://hcai-at-neurips.github.io/site/) (NeurIPS-22). Virtual Conference.
        </td>
    </tr>
    <tr>
        <td className='w-1/2 align-top'>
