...
exports.up = async ({ context: { client } }) => {
  ...
  await taxaCollection.insertOne(csetTaxaEntry);
};
...
exports.down = async ({ context: { client } }) => {
  ...
  await taxaCollection.deleteOne({ namespace: 'CSET' });
};
...
var csetTaxaEntry = {
  ...
  field_list: [
    ...
    },
    {
      ...
      default: 'Harm caused',
      placeholder: '',
      permitted_values: ['Unclear/unknown', 'Near miss', 'Harm caused'],
      weight: 80,
      instant_facet: true,
      required: false,
    },
    ...
    },
    {
      ...
      long_description:
        'Marked "trur" if one or more people died as a result of the accident, "false" if there is no evidence of lives being lost, "unclear" otherwise.',
      display_type: 'bool',
      mongo_type: 'bool',
      default: '',
      placeholder: '',
    ...
    },
    {
      ...
      short_description:
        'If harms were unevenly distributed, this field indicates the basis or bases on which they were unevenly distributed.',
      long_description:
        'If harms were unevenly distributed, this field indicates the basis or bases on which they were unevenly distributed.',
      display_type: 'multi',
      mongo_type: 'array',
    ...
    },
    {
      ...
      default: 'Accident',
      placeholder: 'Accident',
      permitted_values: ['Expert', 'Amateur'],
      weight: 40,
      instant_facet: true,
      required: false,
    },
    ...
    },
    {
      ...
      short_description:
        'Open-ended tags that indicate the hardware and software involved in the AI system(s).',
      long_description:
        'Open-ended tags that indicate the hardware and software involved in the AI system(s).',
      display_type: 'list',
      mongo_type: 'array',
    ...
    },
    {
      ...
      short_description:
        'Open-ended tags that describe the functions and applications of the AI system.',
      long_description:
        'Open-ended tags that describe the functions and applications of the AI system.',
      display_type: 'list',
      mongo_type: 'array',
