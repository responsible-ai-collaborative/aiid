  ...
  <tbody>
    <tr>
      <td className="w-1/2 align-top">
        ![Un marteau sur un bureau avec le drapeau de la République populaire de Chine en arrière-plan.](./images/image5.png)
      </td>
      <td className="w-1/2 align-top">
    ...
    <tr>
      <td className="w-1/2 align-top">
        ![Un panneau d'arrêt avec “Love, STOP, Hate“ écrit dessus](./images/image3.png)
      </td>
      <td className="w-1/2 align-top">
...
<table>
  <tbody>
    <tr>
      ...
      <td className="w-1/2 align-top">
        ![Un graphique linéaire traçant le nombre d'incidents dans la base de données, passant d'un peu moins de 100 en novembre 2020 à un peu plus de 400 en décembre 2022. La ligne se courbe vers le haut, suggérant que la croissance des incidents s'accélère](./images/image7.png)    
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td className="w-1/2 align-top">
        ![La couverture de l'article.](./images/image6.png)
      </td>
    </tr>
  </tbody>
</table>
