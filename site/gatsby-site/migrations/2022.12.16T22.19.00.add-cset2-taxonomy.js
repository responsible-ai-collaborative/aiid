...
exports.up = async ({ context: { client } }) => {
  ...
  console.log(JSON.stringify(csetV1TaxaEntry));
  ...
  const handleWhitespace = (s) => s.replace(/^ */g, '');

  // TODO: Update with changes in CSET v2
  const csetV2TaxaEntry = {
    namespace: 'CSET',
    weight: {
      $numberInt: '70',
    },
    ...
    field_list: [
      ...
      },
      {
        ...
        short_description:
          'Can an AI be directly and clearly linked to tangible or intangible harm?',
        long_description:
      ...
      },
      {
        ...
        long_name:
          'Was a group of people treated differently based upon a protected characteristic?',
        short_description:
