...
- Potentially relevent links in the top three pages of Google search results were opened and read to see whether they have quality information about the event described by the sources. If relevent, they were added to the dataset.
- Other relevent looking incidents that were identified during the search process were included in the data set
