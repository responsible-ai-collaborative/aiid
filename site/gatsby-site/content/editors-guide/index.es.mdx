...
<table className="border-1 border-gray-200 my-4">
  ...
  <tr>
    ...
    <td className="align-top border-1 border-gray-200 px-4 py-2">
      <a to="https://www.cv-foundation.org/openaccess/content_cvpr_2015/html/Nguyen_Deep_Neural_Networks_2015_CVPR_paper.html">
  ...
  <tr>
    ...
    <td className="align-top border-1 border-gray-200 px-4 py-2">
      <a to="https://www.lesswrong.com/tag/paperclip-maximizer">
  ...
  <tr>
    ...
    <td className="align-top border-1 border-gray-200 px-4 py-2">
      <a to="https://www.ted.com/talks/tristan_harris_how_a_handful_of_tech_companies_control_billions_of_minds_every_day">
  ...
  <tr>
    ...
    <td className="align-top border-1 border-gray-200 px-4 py-2">
      <a to="https://thespinoff.co.nz/the-best-of/09-03-2018/the-mystery-of-zach-the-miracle-ai-continued-it-all-just-gets-terribler/">
