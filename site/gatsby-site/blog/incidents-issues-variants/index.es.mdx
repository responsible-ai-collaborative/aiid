...
<figure>
  <img src="./images/ai-image.png" alt="Cars driving down a street, with houses on one side and sidewalk and green space on the other. One of the cars is irregularly-shaped and appears to be made of wood.There are three robots on the sidewalk, one of which is labelled “POLICE”. Among the street signs is one depictin a robot. One of the houses has an Amazon “go” logo and a solar panel on top. There are drones in the sky above the buildings."/>
  <figcaption>
...
<img src="./images/oecd.png" alt="OECD.AI Policy Observatory" className="float-left"/>
