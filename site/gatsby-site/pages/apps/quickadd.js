...
export default class QuickAddForm extends Component {
  ...
  render() {
    ...
    <Layout {...this.props}>
      ...
      <p>The following form will add a report link to the <Link to="/apps/submitted">review queue</Link> for inclusion
      into the AI Incident Database.</p>
      <CONTAINER>
      ...
      <Alert variant="success" show={this.state.showSuccess}>
        Report successfully added to review queue. It will appear
        on the <Link to="/apps/submitted">review queue page</Link> within an hour.
      </Alert>
      <Formik
        initialValues={{url:""}}
      ...
      >
        {( {values,
          ...
          <MYFORM onSubmit={handleSubmit} className="mx-auto">
            ...
            <p>Submitted links are added to a <Link to="/apps/submitted">review queue </Link>
            to be resolved to a new or existing incident record. Incidents submitted with
            <Link to="/apps/submit"> full details </Link> are processed before URLs not posessing
            the full details.</p>
