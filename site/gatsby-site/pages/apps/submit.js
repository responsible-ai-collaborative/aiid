...
const createCallback = () => void 0; // Placeholder function
...
const authorsPopover = (
  popover("Creator of the Linked Content",
...
const incidentDatePopover = (
  popover("When did the incident first occur?",
...
const datePublishedPopover = (
  popover("When did the report become available?",
...
const dateDownloadedPopover = (
  popover("When did you copy the contents of the report into this form?",
...
const reportAddressPopover = (
  popover("Link to the publicly available report",
  `This address will be linked to within many incident database UIs.`)
);
const imageAddressPopover = (
  popover("An image used to preview the incident report",
...
const incidentIDPopover = (
  popover("Is this an existing incident?",
...
const textPopover = (
  popover("Text of the article or transcript of the rich media",
...
export default class SubmitForm extends Component {
  ...
  constructor(props) {
    ...
    const defaultValues = [{data:{
      authors:"", submitters:"Anonymous", title:"",
      text:"", url:"", incident_date:"", date_published:"",
      date_downloaded:"", image_url:"", incident_id:""
    }}]
    this.state = {
      newIncidentData: {},
      admin: false,
          ...
          {( {values,
            ...
            <MYFORM onSubmit={handleSubmit} className="mx-auto">
              ...
              <Form.Group controlId="formAuthors">
                <OverlayTrigger trigger={['hover', 'focus']} placement="top" overlay={authorsPopover}>
              ...
              <Form.Group controlId="formSubmitters">
                <OverlayTrigger trigger={['hover', 'focus']} placement="top" overlay={submittersPopover}>
              ...
              <Form.Group controlId="formIncidentDate">
                <OverlayTrigger trigger={['hover', 'focus']} placement="top" overlay={incidentDatePopover}>
              ...
              <Form.Group controlId="formDatePublished">
                <OverlayTrigger trigger={['hover', 'focus']} placement="top" overlay={datePublishedPopover}>
              ...
              <Form.Group controlId="formDateDownloaded">
                <OverlayTrigger trigger={['hover', 'focus']} placement="top" overlay={dateDownloadedPopover}>
              ...
              <Form.Group controlId="formUrl">
                <OverlayTrigger trigger={['hover', 'focus']} placement="top" overlay={reportAddressPopover}>
              ...
              <Form.Group controlId="formImageUrl">
                <OverlayTrigger trigger={['hover', 'focus']} placement="top" overlay={imageAddressPopover}>
              ...
              <Form.Group controlId="formIncidentID">
                <OverlayTrigger trigger={['hover', 'focus']} placement="top" overlay={incidentIDPopover}>
            ...
            <div style={{display: this.state.admin ? 'block' : 'none' }}>
              ...
              <p>The header row of the file is assumed to match the names of the inputs
                 in the form. Each row will be processed, one at a time, so that it flows
                 through the form validations before submitting.
              </p>
              <p>Record {this.state.csvIndex + 1} of {this.state.csvData.length}</p>
              <Button
                onClick={() => this.previousRecord(setValues)}
              >
                &lt; Previous
              </Button>
              <Button
                onClick={() => this.nextRecord(setValues)}
              >
                Next &gt;
              </Button>
              <CSVReader
