...
<div className="flex">
    <div className="align-top border-1 border-gray-200 px-4 py-2">
...
<div className="flex">
    ...
    <div className="align-top border-1 border-gray-200 px-4 py-2">
        <img src="./images/stopsign.png" alt="A stop sign that has been written over to read “Love STOP hate”"/>
    </div>
</div>
...
We recently made "issue reports" available in the AI Incident Database. You can now search the growing list of [issues](/apps/discover?display=details&is_incident_report=false&page=1), which are also [machine translated](/blog/multilingual-incident-reporting) into [Spanish](/es/apps/discover?display=details&is_incident_report=false&page=1) and [French](/fr/apps/discover?display=details&is_incident_report=false&page=1). You can also search simultaneously across incidents and issues to explore emerging and realized risks in the world.
...
<figure style={{ 'float' : 'right'}}>
  <img src="./images/incidents-over-time.png" alt="A line graph plotting the number of incidents in the database, which increases from somewhat less than 100 in November 2020 to slightly over 400 in December 2022. The line is curved upward, suggesting that the growth in incidents is accelerating."/>
...
<table>
    <thead>
        <tr>
            <th colspan="2" className="align-top border-1 border-gray-200 px-4 py-2">
    ...
    <tbody>
        ...
        <tr>
            <td className="align-top border-1 border-gray-200 px-4 py-2 w-1/2">
            ...
            <td className="align-top border-1 border-gray-200 px-4 py-2 w-1/2">
                <a href="https://arxiv.org/abs/2211.10384">
                    <img src="./images/paper.png" alt="The title page of the paper."/>
                </a>
            </td>
        </tr>
    </tbody>
