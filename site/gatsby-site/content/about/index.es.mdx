...
* **Los usos futuros** [evolucionarán](/research/2-roadmap) a través de las contribuciones de código de la comunidad [de código abierto](https://github.com/PartnershipOnAI/aiid), incluida la base de datos adicional [resúmenes] (/resumen) y [taxonomías](/research/2-roadmap).
...
La base de datos de incidentes es administrada de manera participativa por personas y organizaciones que aportan código, investigación e impactos más amplios. Si desea participar en la gobernanza del proyecto, [comuníquese](/comuníquese) con nosotros e incluya su contribución prevista a la base de datos de incidentes de AI.
