...
export default function QuickSearch() {
  ...
  const setInnerText = () => {
    ...
    if (width >= 350 && width < 450) {
      setSearchPlaceholder(t('Search 5000+ reports'));
    } else if (width >= 450 && width < 500) {
      setSearchPlaceholder(t('Search 5000+ AI harm reports'));
    } else if (width >= 500) {
      setSearchPlaceholder(t('Search over 5000 reports of AI harms'));
    } else {
      ...
      >
        <div className="relative w-full">
          ...
          <input
            ...
            aria-label={t('Search over 5000 reports of AI harms')}
          />
        </div>
