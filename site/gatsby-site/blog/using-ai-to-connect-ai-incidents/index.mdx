...
slug: 'using-ai-to-connect-ai-incidents'
---
...
<video src="/semantically-related.mp4" controls />

The API is currently being used by AIID contributors to identify new submissions reporting on incidents already in the database. It is also planned to be fitted for future use-cases, including:
...
If you would like to help this tool grow and improve or would like to tinker with the systems we have set up, you can find all the code [in our GitHub repository](https://github.com/responsible-ai-collaborative/nlp-lambdas).
