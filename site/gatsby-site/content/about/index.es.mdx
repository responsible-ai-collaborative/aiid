...
La base de datos de incidentes es administrada de manera participativa por personas y organizaciones que contribuyen con código, investigación e impactos más amplios. Si desea participar en la gobernanza del proyecto, [póngase en contacto](/póngase en contacto) con nosotros e incluya su contribución prevista a la base de datos de incidentes de IA.
...
**Contribuciones:** Heather desarrolla investigaciones de incidentes de IA además de su supervisión de la [taxonomía CSET] (https://incidentdatabase.ai/taxonomy/cset).
