  ...
  <tbody>
    <tr>
      <td className="w-1/2 align-top">
        ![A gavel on a desk with the flag of the People's Republic of China in the background](./images/image5.png)
      </td>
      <td className="w-1/2 align-top">
    ...
    <tr>
      <td className="w-1/2 align-top">
        ![A stop sign that has been written over to read “Love STOP hate](./images/image3.png)
      </td>
      <td className="w-1/2 align-top">
...
<table>
  <tbody>
    <tr>
      ...
      <td className="w-1/2 align-top">
        ![A line graph plotting the number of incidents in the database, which increases from somewhat less than 100 in November 2020 to slightly over 400 in December 2022. The line is curved upward, suggesting that the growth in incidents is accelerating.](./images/image7.png)    
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td className="w-1/2 align-top">
        ![The title page of the paper.](./images/image6.png)
      </td>
    </tr>
  </tbody>
</table>
