...
<div>![The entities table with the new "Incident Responses" column highlighted](./images/entities-incident-responses.png)</div>

To give companies that submit incident responses credit for their contributions to AI safety and fairness,
the AI Incident Database will be integrating elements to the website lauding companies for their good
