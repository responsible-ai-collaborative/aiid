...
<div>[![The discover app filtered by racial disparate impact](./images/facet.png)](/apps/discover?classifications=CSET%3AHarm%20Distribution%20Basis%3ARace)</div>
...
<div>[![Collection biases of geography](./images/pie_geography.png)](/taxonomy/cset)</div>
...
<div>[![Sampling biases of companies](./images/pie_companies.png)](/taxonomy/cset)</div>
