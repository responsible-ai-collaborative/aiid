...
export type Mutation = {
  ...
  mergeEntities: Scalars['String']['output'];
...
export type MergeEntitiesMutation = { __typename?: 'Mutation', mergeEntities: string };
