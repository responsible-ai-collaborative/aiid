  ...
  it('Should submit a new report once all fields are filled properly', () => {
    ...
    cy.wait('@submitReport').then((xhr) => {
      expect(xhr.request.body.arguments[0]).to.deep.include({
        ...
        image_url: 'https://cbsnews3.cbsistatic.com/hub/i/r/2015/03/17/01a38576-5108-40f7-8df8-5416164ed878/thumbnail/1200x630/ca8d35fe6bc065b5c9a747d92bc6d94c/154211248.jpg',
        tags: ['New Tag'],
