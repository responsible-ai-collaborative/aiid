...
La AI Incident Database indexe les "rapports d'incidents" écrits, qui jusqu'à présent étaient entièrement en anglais. Désormais, lorsqu'un incident est signalé, le rapport est étiqueté avec une langue source et traduit automatiquement dans toutes les langues actuellement prises en charge.
...
**_Pouvons-nous éviter d'ajouter la AI Incident Database en tant qu'incident dans la base de données des incidents AI ?_**
