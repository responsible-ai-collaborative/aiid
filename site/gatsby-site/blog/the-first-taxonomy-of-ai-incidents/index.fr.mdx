...
<div>[![L'application de découverte filtrée par impact racial disparate](./images/facet.png)](/apps/discover?classifications=CSET%3AHarm%20Distribution%20Basis%3ARace)</div>
...
<div>[![Biais de collecte de la géographie](./images/pie_geography.png)](/taxonomy/cset)</div>
...
<div>[![Biais d'échantillonnage des entreprises](./images/pie_companies.png)](/taxonomy/cset)</div>
