...
Subsequent to initial dataset collection, [Sean McGregor](https://seanbmcgregor.com/) developed a [Discover](/about_apps/1-discover) application that supported the indexing and cleaning of the more than 1k reports assembled in Phase 1.
