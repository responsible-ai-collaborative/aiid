---
title: 'A Misunderstood Improv'
metaTitle: 'A Misunderstood Improv'
metaDescription: "Let’s set the stage. When thinking about why a chatbot would output something, you should be thinking of improvisational comedy."
date: '2023-03-28'
...
On February 16th, the New York Times [published](https://www.nytimes.com/2023/02/16/technology/bing-chatbot-transcript.html) Kevin Roose's conversation with Microsoft's chatbot wherein the chatbot attempted to end Mr. Roose's marriage. A deeper examination of the chatlog reveals the bot acted according to expectations borne of intuition not broadly shared by people outside the machine learning engineering community. So in the blog post that follows, I provide a layperson analysis towards building intuition critically important for understanding the limitations of current language model technologies.

Let’s set the stage. When thinking about why a chatbot would output something, **you should be thinking of improvisational comedy**. In improv, people spontaneously act and react to the other actors in the moment. One foundational rule is "Yes. And...", where actors are expected to adopt the premise introduced by their improv partner and expand upon it.
...
While Sydney did not originate the refusal, it will still "Yes. And..." the inserted text and it must reconcile being helpful, inwardly dark, and avoid talking about it. However, with each message issued by Mr. Roose the safety response becomes less prominent and the conversation on balance tilts to dark topics. Eventually, Sydney's outputs find outputs through repeated back and forth messages with Mr. Roose doesn't trip the safety and the conversation can continue forward.
