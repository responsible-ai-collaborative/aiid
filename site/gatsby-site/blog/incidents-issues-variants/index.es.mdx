...
<div className="flex">
     <div className="alinear-borde superior-1 borde-gris-200 px-4 py-2">
         <p><a href="/reports/2304">"China desarrolla un 'fiscal' de IA para presentar cargos 'con un 97 % de precisión'"</a></p>
         <p><em>No es un incidente</em>: el evento de daño inevitable aún no ha ocurrido.</p>
     </div>
     <div className="alinear-borde superior-1 borde-gris-200 px-4 py-2">
         <img src="./images/chinese-flag-gavel.png" alt="Un mazo sobre un escritorio con la bandera de la República Popular China de fondo."/>
     </div>
</div>
<div className="flex">
     <div className="alinear-borde superior-1 borde-gris-200 px-4 py-2">
         <img src="./images/the-national-tribune.png" alt="La Tribuna Nacional"/>
     </div>
     <div className="alinear-borde superior-1 borde-gris-200 px-4 py-2">
         <p><a href="/reports/2296">"IA y deepfakes presentan nuevos riesgos para las relaciones en Internet"</a></p>
         <p><em>No es un incidente</em>: Nos falta un ejemplo concreto.</p>
     </div>
</div>
<div className="flex">
     <div className="alinear-borde superior-1 borde-gris-200 px-4 py-2">
         <p><a href="/reports/2294">"Ligeras modificaciones en letreros de calles pueden engañar por completo a los algoritmos de aprendizaje automático"</a></p>
         <p><em>No es un incidente</em>: La vulnerabilidad aún no se ha explotado.</p>
     </div>
     <div className="alinear-borde superior-1 borde-gris-200 px-4 py-2">
         <img src="./images/stopsign.png" alt="Una señal de alto que se ha escrito para decir 'Amor DETÉN el odio'"/>
     </div>
</div>
...
Recientemente pusimos a disposición "informes de problemas" en la base de datos de incidentes de AI. Ahora puede buscar en la creciente lista de [problemas](/apps/discover?display=details&is_incident_report=false&page=1), que también están [traducidos automáticamente](/blog/multilingual-incident-reporting) al [español](/es /apps/discover?display=detalles&is_incident_report=false&page=1) y [inglés](/fr/apps/discover?display=detalles&is_incident_report=false&page=1). También puede buscar simultáneamente en incidentes y problemas para explorar riesgos emergentes y reales en el mundo.
...
<a href=""><img src="./images/oecd.png" alt="Observatorio de Políticas de la OCDE.AI" className="float-left"/></a>

Entre los foros más importantes para resolver estas preguntas se encuentra el [Grupo de trabajo sobre clasificación y riesgo de la OCDE.ai](https://oecd.ai/en/network-of-experts/working-group/1137), a través del cual el Responsible AI Collaborative (Collab) proporciona información sobre definiciones intergubernamentales emergentes para un marco de riesgo de IA de dos niveles similar al que se explora aquí.

La adopción de definiciones compartidas para los riesgos de la IA es importante y oportuna.

<figure style={{ 'flotante': 'derecha'}}>
   <img src="./images/incidents-over-time.png" alt="Un gráfico de líneas que traza la cantidad de incidentes en la base de datos, que aumenta de algo menos de 100 en noviembre de 2020 a un poco más de 400 en diciembre de 2022. La línea se curva hacia arriba, lo que sugiere que el crecimiento de los incidentes se está acelerando" />
   <figcaption>Incidentes invertidos a lo largo del tiempo</figcaption>
</figure>
...
<table>
     <thead>
         <tr>
             <th colspan="2" className="alinear-borde superior-1 borde-gris-200 px-4 py-2">
                 Lea el documento de investigación (se expande en varios elementos)
             </th>
         </tr>
     </thead>
     <tbody>
         <tr>
             <td colspan="2" className="alinear-borde superior-1 borde-gris-200 px-4 py-2">
                 McGregor, S., Paeth, K. y Lam, K. (2022). <i>Indización de riesgos de IA con incidentes, problemas y variantes.</i>
                 En Actas del <a href="https://hcai-at-neurips.github.io/site">Taller de NeurIPS sobre IA centrada en humanos</a> (NeurIPS-22). Conferencia Virtual.
             </td>
         </tr>
         <tr>
             <td className="alinear-borde superior-1 borde-gris-200 px-4 py-2 w-1/2">
             ...
             <td className="alinear-borde superior-1 borde-gris-200 px-4 py-2 w-1/2">
                 <a href="https://arxiv.org/abs/2211.10384">
                     <img src="./images/paper.png" alt="La portada del artículo."/>
                 </a>
             </td>
         </tr>
     </tbody>
