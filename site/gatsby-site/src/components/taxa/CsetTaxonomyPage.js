...
export default function CsetTaxonomyPage(props) {
  ...
  return (
    <>
      ...
      <div className="max-w-3xl [&_p]:my-2">
        <p>
          <Trans i18nKey="csetCharts">
            The CSET AI Harm Taxonomy for AIID is the second edition of the CSET incident taxonomy.
            It characterizes the harms, entities, and technologies involved in AI incidents and the
        ...
        <p>
          <Trans>
            AI harm has four elements which, once appropriately defined, enable the identification
            of AI harm. These key components serve to distinguish harm from non-harm and AI harm
            from non-AI harm. To be an AI harm, there must be:
          </Trans>
        </p>
        <ul>
          <li>
        ...
        <p>
          <Trans>
            Not every incident in AIID meets this definition of AI harm. The below bar charts show
            the annotated results for both all AIID incidents and incidents that meet the CSET
            definition of AI harm.
          </Trans>
        </p>
        ...
        <p>
          <Trans i18nKey={'csetChartDeveloped'}>
            ...
            other organizations&apos; definitions. As a result, other organizations may make
            different assessments on whether any particular AI incident is (or is not) AI harm.
            Details about CSET&apos;s definitions for AI harm can be found
            <a
              href="https://github.com/georgetown-cset/CSET-AIID-harm-taxonomy"
              target="_blank"
              rel="noreferrer"
        ...
        <GroupBarChart
          ...
          subtitle={
            <Trans>
              ...
              intangible harm covers bias and fairness issues concerning AI. However, the bias must
              be associated with a group having a protected characteristic.
            </Trans>
          }
            ...
            <>
              <div>
                ...
                <ul>
                  <li>
                    <Trans>
                      Level 1: the system operates independently with no simultaneous human
                      oversight.
                    </Trans>
                  </li>
                  <li>
