...
* An *autonomous car* [kills a pedestrian](https://incidentdatabase.ai/discover/index.html?incident_id=4)
* A *trading algorithm* causes a market "[flash crash](https://incidentdatabase.ai/discover/index.html?incident_id=28)" where billions of dollars transfer between parties
* A *facial recognition system* [causes an innocent person to be arrested](https://incidentdatabase.ai/discover/index.html?s=&incident_id=74)
