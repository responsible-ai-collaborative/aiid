...
//  });
  it('', () => {
    cy.visit(url);
    cy.get(`[data-cy="header-previous-incident-link"]`).should('be.visible').should('have.attr', 'href', '/cite/9');
    cy.get(`[data-cy="header-next-incident-link"]`).should('be.visible').should('have.attr', 'href', '/cite/11');
  });
  it('', () => {
    cy.visit('/cite/1');
    cy.get(`[data-cy="header-previous-incident-link"]`).should('not.exist');
    cy.get(`[data-cy="header-next-incident-link"]`).should('be.visible').should('have.attr', 'href', '/cite/2');
  });
