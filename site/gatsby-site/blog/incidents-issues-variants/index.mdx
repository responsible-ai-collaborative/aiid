...
We recently made "issue reports" available in the AI Incident Database. You can now search the growing list of [issues](https://incidentdatabase.ai/apps/discover?display%3Ddetails%26is_incident_report%3Dfalse%26page%3D1&sa=D&source=editors), which are also [machine translated](https://incidentdatabase.ai/blog/multilingual-incident-reporting) into [Spanish](https://incidentdatabase.ai/es/apps/discover?display%3Ddetails%26is_incident_report%3Dfalse%26page%3D1&sa=D&source=editors) and [French](https://incidentdatabase.ai/fr/apps/discover?display%3Ddetails%26is_incident_report%3Dfalse%26page%3D1&sa=D&source=editors). You can also search simultaneously across incidents and issues to explore emerging and realized risks in the world.
...
<table>
    <tr>
        <td className='w-1/2 align-top bg-blue-900'>
