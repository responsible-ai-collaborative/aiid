...
The following database collections are licensed under the [Creative Commons attribution share-alike license](https://creativecommons.org/licenses/by-sa/4.0/)
...
These are available in the [database snapshots](https://incidentdatabase.ai/research/snapshots/).

### Exclusions

The following data is **not** licensed under the creative commons license.

* submissions: Prospective reports before they are rotated into the reports collection.
* The text field of the reports collection stored in the field named "text".
* Contents displayed within the database not contained within the database snapshots (e.g., the source of images and videos). The snapshot contains URLs to these resources that are licensed.

### Clarifications

If you require additional licenses, clarifications, or ongoing support, please email info@incidentdatabase.ai.
