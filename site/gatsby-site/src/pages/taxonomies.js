      ...
      <div className="styled-main-wrapper">
        ...
        <ul className="list-revert pl-8">
          ...
          <li>
            <p>
              <Trans>
                <LocalizedLink to="/taxonomy/mit">MIT Risk Repository</LocalizedLink> The MIT Risk
                Repository contains detailed records of AI-related risks extracted from a variety of
                sources, categorized into high-level and mid-level taxonomies. Its high-level Causal
                Taxonomy includes attributes such as the entity responsible for the risk (human, AI,
                or other), the intent (intentional, unintentional, or other), and the timing
                (pre-deployment, post-deployment, or other). Its mid-level Domain Taxonomy
                categorizes risks into 23 specific domains like discrimination, misinformation,
                malicious use, and human-computer interaction issues.
              </Trans>
            </p>
          </li>
        </ul>
