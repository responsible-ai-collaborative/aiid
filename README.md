...
1. Clone this repository, `git clone git@github.com:PartnershipOnAI/aiid.git` (you need to have git LFS installed and if not granted access to Netlify Large Media, please set ` GIT_LFS_SKIP_SMUDGE=1` before cloning.)
